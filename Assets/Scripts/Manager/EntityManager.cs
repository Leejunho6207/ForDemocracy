...
public class EntityManager : MonoBehaviour
{
    ...
    const int MAX_ENTITY_COUNT = 3; // 필드의 카드배치 한계수!
    ...
    bool ExistMyEmptyEntity => myEntities.Exists(Matrix4x4 => Matrix4x4 == myEmptyEntity);
    ...
    public bool SpawnEntity(bool isMine, ADCard item, Vector3 spawnPos)
    {
        if (isMine)
        {
    ...
    public void EntityMouseDrag()
    {
        ...
        bool existTarget = false;//2P 엔티티 찾기
    ...
    public void AttackableaReset(bool isMine)
    {
        var targetEntities = isMine  ? myEntities : otherEntities;
